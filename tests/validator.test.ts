...
describe("ValidatorService", () => {
    describe("mapRequestSchema", () => {
        it("should validate valid map request data", () => {
            ...
            const result = ValidatorService.validate(ValidatorService.mapRequestSchema, validData);
        ...
        it("should throw ValidationError for invalid data", () => {
            ...
            expect(() => {
                ValidatorService.validate(ValidatorService.mapRequestSchema, invalidData);
    ...
    describe("createOrderRequestSchema", () => {
        ...
        it("should throw ValidationError for invalid email", () => {
            ...
            expect(() => {
                ValidatorService.validate(ValidatorService.createOrderRequestSchema, invalidData);
            }).toThrow(ValidationError);
        });
    ...
    describe("queryOrderRequestSchema", () => {
        ...
        it("should throw ValidationError for empty MerchantOrderNo", () => {
            ...
            expect(() => {
                ValidatorService.validate(ValidatorService.queryOrderRequestSchema, invalidData);
            }).toThrow(ValidationError);
        });
    });
